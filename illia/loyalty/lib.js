...
var talkable = window.talkable = function() {
  ...
  var utils = {
    ...
    getUUID: function() {
      return utils.location_parameter(UUID_KEY) || this.getCookie(UUID_KEY);
    },
  ...
  var methods = {
    ...
    show_loyalty: function(data) {
      ...
      console.log('LOYALTY_OPTIN_KEY var value:', LOYALTY_OPTIN_KEY)

      console.log('2', utils.getCookie(LOYALTY_OPTIN_KEY))

      console.log('utils.getCookie(LOYALTY_OPTIN_KEY)', utils.getCookie('tkbl_loyalty_optin'))

      utils.formIframe(options, '/loyalty/show', {
        email: customerData.email,
        optin: utils.getCookie(LOYALTY_OPTIN_KEY),
      });
    },
    ...
    show_loyalty_redeem_widget: function(data) {
      ...
      utils.formIframe(options, '/loyalty/redeem_widget', { email: customerData.email });
    },
