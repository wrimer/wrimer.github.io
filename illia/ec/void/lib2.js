...
var talkable = window.talkable = function() {
  ...
  var utils = {
      ...
      listen: function(callback) {
        ...
        var isOriginAllowed = function(origin) {
          ...
          return /\.talkable\.(com|local)$/.test(originHostname) ||
            'd2jjzw81hqbuqv.cloudfront.net' === originHostname ||
            'di6re4dxelnn2.cloudfront.net' === originHostname ||
            'd3pfcpkel4p4mo.cloudfront.net' === originHostname ||
            'curebit-development.s3.amazonaws.com' === originHostname ||
    ...
    addIframeElement: function(url, options) {
      console.log('addIframeElement o', options)
      console.log('url', url)
    ...
    formStaticWidget: function(options, urlParameters) {
      if (urlParameters.affiliate_campaign_id) return false;
      if (urlParameters.campaign_tags) return false;
      if (urlParameters.tkbl_expand) return false;
